...
public final class CoordinateUtils {
    ...
    public static long getChunkKey(final Entity entity) {
        return ((long)(MathHelper.floor(entity.posZ) >> 4) << 32) | ((MathHelper.floor(entity.posX) >> 4) & 0xFFFFFFFFL);
    }
    ...
    public static long getChunkSectionKey(final Entity entity) {
        return ((MathHelper.floor(entity.posX) << (SECTION_X_SHIFT - SECTION_TO_BLOCK_SHIFT)) & (SECTION_X_MASK << SECTION_X_SHIFT)) |
                ((MathHelper.lfloor(entity.posY) >> SECTION_TO_BLOCK_SHIFT) & (SECTION_Y_MASK << SECTION_Y_SHIFT)) |
                ((MathHelper.lfloor(entity.posZ) << (SECTION_Z_SHIFT - SECTION_TO_BLOCK_SHIFT)) & (SECTION_Z_MASK << SECTION_Z_SHIFT));
    }
    ...
    public static long getBlockKey(final Entity entity) {
        return ((long)entity.posX & 0x7FFFFFF) | (((long)entity.posZ & 0x7FFFFFF) << 27) | ((long)entity.posY << 54);
    }
