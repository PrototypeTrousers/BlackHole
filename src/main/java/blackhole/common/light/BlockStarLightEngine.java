...
public final class BlockStarLightEngine extends StarLightEngine {
    ...
    @Override
    protected final void checkBlock(final IExtendedChunkProvider lightAccess, final int worldX, final int worldY, final int worldZ) {
        ...
        final VariableBlockLightHandler customBlockHandler = ((ExtendedWorld)lightAccess).getCustomLightHandler();
    ...
    protected int calculateLightValue(final IExtendedChunkProvider lightAccess, final int worldX, final int worldY, final int worldZ,
        ...
        if (opacity == -1) {
            ...
            opacity = centerState.getLightOpacity(lightAccess.getWorld(), this.recalcCenterPos);
    ...
    @Override
    public void lightChunk(final IExtendedChunkProvider lightAccess, final Chunk chunk, final boolean needsEdgeChecks) {
        // setup sources
        final int emittedMask = this.emittedLightMask;
        final VariableBlockLightHandler customBlockHandler = ((ExtendedWorld)lightAccess.getWorld()).getCustomLightHandler();
