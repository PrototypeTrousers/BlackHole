...
public final class StarLightInterface {
    ...
    protected final IExtendedChunkProvider lightAccess;
    ...
    public StarLightInterface(final IExtendedChunkProvider lightAccess, final boolean hasSkyLight, final boolean hasBlockLight) {
        ...
        this.skyReader = !hasSkyLight ? IWorldLightListener.Dummy : new IWorldLightListener() {
            @Override
            public NibbleArray getData(final SectionPos pos) {
                ...
                if (chunk == null || (!StarLightInterface.this.isClientSide && !chunk.isLightPopulated())) {
                    return null;
                }
        ...
        this.blockReader = !hasBlockLight ? IWorldLightListener.Dummy : new IWorldLightListener() {
            @Override
            public NibbleArray getData(final SectionPos pos) {
                final Chunk chunk = StarLightInterface.this.getAnyChunkNow(pos.getX(), pos.getZ());
    ...
    public IExtendedChunkProvider getLightAccess() {
